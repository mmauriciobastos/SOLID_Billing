...
#[ApiResource(
    ...
    operations: [
        new GetCollection(
            extraProperties: ['openapi_context' => ['summary' => 'Search users']],
            provider: UsersProvider::class,
        ),
        new Get(
            extraProperties: ['openapi_context' => ['summary' => 'Get user']],
            provider: UserProvider::class,
        ),
        new Post(
            extraProperties: ['openapi_context' => ['summary' => 'Create user']],
