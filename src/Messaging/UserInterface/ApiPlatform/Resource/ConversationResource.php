...
#[ApiResource(
    ...
    operations: [
        new GetCollection(
            extraProperties: ['openapi_context' => ['summary' => 'List conversations.']],
            normalizationContext: ['groups' => 'read'],
            provider: ConversationsProvider::class,
        ),
        new Get(
            extraProperties: ['openapi_context' => ['summary' => 'Get conversation details.']],
            normalizationContext: ['groups' => 'read'],
            provider: ConversationProvider::class,
        ),
        new Post(
            extraProperties: ['openapi_context' => ['summary' => 'Create new conversation.']],
